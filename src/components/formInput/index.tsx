...
export default function FormInput({
  ...
  return (
    <View className={`space-y-2 ${otherStyles}`}>
      ...
      <View
        className={`w-full px-4 bg-gray-600 border-b-2 border-gray-500 flex flex-row items-center ${!props.editable && "bg-gray-700"
          }`}
        style={[
      ...
      >
        <TextInput
          className={`flex-1 font-psemibold text-base ${!props.editable && "text-gray-400"
            }`}
          value={value}
