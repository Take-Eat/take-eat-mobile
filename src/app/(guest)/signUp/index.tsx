import { View, Text, ScrollView, Dimensions, Image, Pressable, TouchableOpacity } from "react-native";
        ...
        <ScrollView>
            ...
            >
                ...
                <View className="flex gap-3 justify-center items-center">
                    ...
                    <TouchableOpacity onPress={() => { router.push("/(menu)/termsOfUse") }}>
            ...
            {/* <TouchableOpacity className="absolute bottom-12 right-0 left-0">
