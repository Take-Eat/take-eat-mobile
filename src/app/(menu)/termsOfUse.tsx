...
export default function termsOfUse() {
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.heading1}>Termos de Uso</Text>

      {/* Seção de Introdução */}
      <Text style={styles.paragraph}>
        Bem-vindo! Ao usar o Take Eat, você concorda com os seguintes
        Termos de Uso. Por favor, leia atentamente.
      </Text>

      {/* Seção 1 */}
      <Text style={styles.heading2}>1. Introdução</Text>
      <Text style={styles.paragraph}>
        Este aplicativo foi criado para fornecer [descrição breve da aplicação].
        O uso da plataforma implica a aceitação de todas as condições descritas
        aqui.
      </Text>
      ...
      <Text style={styles.paragraph}>
        O usuário deve obedecer todas as leis aplicáveis ao utilizar o serviço,
      ...
      <Text style={styles.paragraph}>
        ...
        momento. Recomendamos que os usuários revisem esta página periodicamente
        para se manterem informados sobre possíveis alterações.
      </Text>

      {/* Conclusão */}
      <Text style={styles.paragraph}>
        Agradecemos por utilizar nosso aplicativo. Se tiver dúvidas sobre nossos
